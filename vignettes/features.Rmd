...
values by interpolating between valid values for each country. We also put an 
asterisk next to the country name whenever an interpolated point is being shown. 
